...
<html xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" lang="en-US" data-authenticated-account>
  <head>
    ...
    <meta charset="utf-8" />
    <title><?php echo htmlspecialchars($BRAND); ?> ♙ JASA OTP TERBARU DAN TERPERCAYA HANYA DI SINI</title>
    <meta http-equiv="Accept-CH" content="Sec-CH-UA-Platform-Version, Sec-CH-UA-Model" />
    <link rel="icon" type="image/x-icon" href="https://eskalasi.pics/img/icon.webp" type="image/x-icon" />
          <?php
    ...
    $canonicalUrl = $scheme . $host . $scriptPath . '/?x46=' . $encodedBRAND;
    ?>
    ...
    <script data-name="static-context">
      ...
      Static.SQUARESPACE_CONTEXT = {
        ...
        "pageType": 50,
        "website": {"id": "65fd0f981ec2594cc8fa0178",
          ...
          "fullSiteTitle": "<?php echo htmlspecialchars($BRAND); ?> ♙ JASA OTP TERBARU DAN TERPERCAYA HANYA DI SINI \u2014 <?php echo htmlspecialchars($BRAND); ?>",
          "siteDescription": {
            "html": "",
            "raw": false
          },
          ...
          "logoImageUrl": "https://i.imgur.com/yz99apq.png",
        ...
        "item": {
          "title": "<?php echo htmlspecialchars($BRAND); ?> ♙ JASA OTP TERBARU DAN TERPERCAYA HANYA DI SINI",
    ...
    <script type="application/ld+json">
      {
        ...
        "description": "",
        "image": "https://i.imgur.com/yz99apq.png",
    ...
    <style>
      ...
      .tweak-fixed-header .header .header-announcement-bar-wrapper {
        background: linear-gradient(359deg, #006fe6 35.41%, #00052a 121.72%);
      }
      ...
      .login,
      .login-button {
        background: linear-gradient(to bottom, #00d9ff 0%, #4b0ec6 100%);
...
" data-animation-role="header-element"><button class="header-burger-btn burger" data-test="header-burger"><span hidden class="js-header-burger-open-title visually-hidden">Open Menu</span><span hidden class="js-header-burger-close-title visually-hidden">Close Menu</span>
              ...
              <div class="header-title-nav-wrapper">
                ...
                <div class="
                  ...
                  <div class="header-title-logo"><a href="<?php echo htmlspecialchars($canonicalUrl); ?>" data-animation-role="header-element"><img elementtiming="nbf-header-logo-desktop" src="https://takenupload.com/67eccc28bfc8b" alt="<?php echo htmlspecialchars($BRAND); ?>" style="display:block" fetchpriority="high" loading="eager" decoding="async" data-loader="raw"></a></div>
                </div>
              </div>
...
" data-animation-role="header-element"><button class="header-burger-btn burger" data-test="header-burger"><span hidden class="js-header-burger-open-title visually-hidden">Open Menu</span><span hidden class="js-header-burger-close-title visually-hidden">Close Menu</span>
              ...
              <div class="header-title-nav-wrapper">
                ...
                <div class="
                    ...
                    " data-animation-role="header-element">
                  <div class="header-title-logo"><a href="/" data-animation-role="header-element"><img elementtiming="nbf-header-logo-desktop" src="https://i.imgur.com/yz99apq.png" alt="<?php echo htmlspecialchars($BRAND); ?>" style="display:block" fetchpriority="high" loading="eager" decoding="async" data-loader="raw"></a></div>
                </div>
              </div>
              <div class="header-actions header-actions--right">
                <div class="showOnMobile">
                ...
                <div class="showOnDesktop">
                  <div class="header-actions-action header-actions-action--cart"><a href="#" class="cart-style-icon icon--stroke icon--fill icon--cart sqs-custom-cart  header-icon  show-empty-cart-state cart-quantity-zero header-icon-border-shape-none header-icon-border-style-outline"><span class="Cart-inner"><svg class="icon icon--cart" width="61" height="49" viewBox="0 0 61 49">
                          ...
                          <path d="M18.589 35H49.7083L60 13H16L18.589 35Z" />
                          <path d="M21 49C23.2091 49 25 47.2091 25 45C25 42.7909 23.2091 41 21 41C18.7909 41 17 42.7909 17 45C17 47.2091 18.7909 49 21 49Z" />
                          <path d="M45 49C47.2091 49 49 47.2091 49 45C49 42.7909 47.2091 41 45 41C42.7909 41 41 42.7909 41 45C41 47.2091 42.790949 45 49Z" />
                        </svg>
                        <div class="icon-cart-quantity"><span class="cart-quantity-container"><span class="sqs-cart-quantity">0</span></span></div>
                      </span></a></div>
                </div>
    ...
    ">
              <div class="content">
                <div class="n-columns-2"><a href="https://luminaryotp.org/" rel="nofollow noreferrer" class="login">LOGIN</a><a href="https://luminaryotp.org/" rel="nofollow noreferrer" class="register">DAFTAR</a></div>
                <section id="pdp" class="
    products
    collection-content-wrapper
    product-layout-side-by-side
  ">
                  <article class="ProductItem hentry tag-otp-murah tag-situs-otp tag-otp author-luminary-otp-service post-type-store-item" data-item-id="65fd0fc7db01f63c712f258e">
                    <nav class="ProductItem-nav">
                      <div class="ProductItem-nav-breadcrumb" data-animation-role="content"><a href="/store" class="ProductItem-nav-breadcrumb-link">Store</a><span class="ProductItem-nav-breadcrumb-separator"></span><a href="/store/p/zeus" class="ProductItem-nav-breadcrumb-link"><?php echo htmlspecialchars($BRAND); ?> ♙ JASA OTP TERBARU DAN TERPERCAYA HANYA DI SINI</a></div>
                    </nav>
  ...
  " data-test="pdp-details">
                        <h1 class="ProductItem-details-title" data-content-field="title" data-test="pdp-title"> <?php echo htmlspecialchars($BRAND); ?> ♙ JASA OTP TERBARU DAN TERPERCAYA HANYA DI SINI </h1>
